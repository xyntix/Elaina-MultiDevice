...
global.sgh = 'https://github.com/xyntix/' //Link Githubmu
global.sgc = '-'
global.sdc = '-' //Isi Pake Link Discordmu Kalo Gada Biarin aja
global.snh = '-' //Hmmm, Ini boleh kalian isi terserah :v

/*============== PAYMENT ==============*/
global.pdana = 'Pls Contact me on Private' //Nomor Danamu
global.ppulsa = 'Pls Contact me on Private ' //Nomor SimCard Yang Kamu Pake
...
/*============== STAFF ==============*/
global.owner = [
  ['6289612228750', '𝑅𝑒𝑒𝓎𝒶', true] //Ganti jd nomormu sama Namamu
...
/*============== WATERMARK ==============*/
global.wm = '                「 Secret 𝙱𝙾𝚃 秘密 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘Secret - BOT˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ Secret 𝙱𝙾𝚃'
global.botdate = `⫹⫺ 𝗛𝗮𝗿𝗶: ${week} ${date}`
global.bottime = `𝗪𝗮𝗸𝘁𝘂 : ${wktuwib}`
global.titlebot = '🎋 ┊ 𝗥𝗣𝗚 ʙᴏᴛ ᴡʜᴀᴛsᴀᴘᴘ'
global.author = global.wm
global.logo = 'https://cdn.shopify.com/s/files/1/0077/8027/0133/files/background_2_1180x.png'
